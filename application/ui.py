...
class InsidePage(tk.Frame):
    def __init__(self, master, controller, info, startPage=None):
        ...
        #add password button                      
        self.add_new_password_button = tk.Button(self, text="Add New Password", font=TRUE_FONT, height=1, width=20, activebackground='#FFFFFF', activeforeground='#40c4ff', relief=tk.FLAT, bg='#40c4ff', fg='#40c4ff', command=lambda: controller.show_frame(AddPassword))
